...
const qnaList = [
  ...
  },
  {
    q: '제주도로 여행을 간다구?',
    a: [
      { answer: '도착해선 이거하고<br>나가선 이거하고 그다음엔...', type: [4, 11, 5, 9, 2, 15, 0, 12] },
  ...
  },
  {
    q: '도전하고 싶은 일이 생겼다!',
    a: [
      { answer: '한 번도 해보지 않은 일인데<br>내가 할 수 있을까...', type: [5, 7, 9, 3, 0, 10, 12, 13 ] },
  ...
  },
  {
    q: '다음 주가 중요한 시험일 때',
    a: [
      { answer: '오늘은 이 공부하고<br>내일은 이 공부해야겠다!', type: [4, 11, 5, 9, 2, 15, 0, 12 ] },
